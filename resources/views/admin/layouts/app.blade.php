        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{ route('admin.index') }}" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>BorerAlo</strong></h4>
                        </span>
                        <i>
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            <li class="menu-title">boreralo</li>
                            <li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-list"></i> <span>Categories </span> <span class="menu-arrow"></span></a>
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    @php echo date('Y'); @endphp © BorerAlo
                </footer>
